...
const Status = ({ status, t }: StatusProps) => {
...
export const RoundStatusIcon = ({ status }: { status: RoundStatus }) => {
  ...
  switch (status) {
    case RoundStatus.COMPLETED:
      return <DoneAllIcon color={getStatusColor(status)} {...commonProps} />

    case RoundStatus.CANCELLED:
      return (
        <NotificationImportantIcon color={getStatusColor(status)} {...commonProps} />
      )
    ...
    case RoundStatus.PAUSED:
      return <PauseIcon color={getStatusColor(status)} {...commonProps} />

    case RoundStatus.PENDING:
      return <WorkHistoryIcon color={getStatusColor(status)} {...commonProps} />
